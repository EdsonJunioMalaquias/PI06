				...
				<div class="md-layout">
						...
						<div  class="md-layout-item md-small-size-50 md-size-50">
							<form>
								...
								<md-button v-on:click.prevent="AdicionarExame()" class="md-raised md-success" >Adcionar Exame</md-button>
								 	<br>
									 <br>						
								<md-title>Exames Incluidos</md-title>
								<ul>
								...
								<md-button @click.prevent="CadastrarConsulta()" class="md-raised md-success">Cadastrar Consulta</md-button>
